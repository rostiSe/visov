...
import { CreatePackageDialog } from "@/components/package-creation-dialog";
  ...
  return (
    <div className="flex flex-col gap-4">
        <div className="relative">
                ...
                />
                <div className="absolute flex gap-2 items-center flex-row-reverse bottom-2 z-20 right-2">
                <GroupDrawer
                title="Frage-Pakete"
                ...
                />
                <CreatePackageDialog groupId={group.id} />
