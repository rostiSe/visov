...
export default function GroupCard({group}: {group: GroupWithMembers}) {
  return (
    ...
    <Card className="rounded-xl shadow-none transition-all border-amber-100 hover:bg-amber-100 px-2  overflow-hidden flex flex-row justify-start items-center gap-4">
